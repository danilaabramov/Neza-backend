...
import UserModel from "../models/Stock.js";
    ...
    try {
        ...
        StockModel.findOne(
            ...
            async (err, doc) => {
                ...
                console.log(JSON.parse(doc.timeSeries)[0].price)
                ...
                await UserModel.findOneAndUpdate({
                    ...
                    },
                    {
                        ...
                        $inc: {
                            stocksBalance: JSON.parse(doc.timeSeries)[0].price,
                        },
                        $dec: {
                            currencyBalance: JSON.parse(doc.timeSeries)[0].price,
                        }
                    },
                    {
